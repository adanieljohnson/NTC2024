...
The case teaching resources on this site are organized around a modified ADDIE model of curriculum design (U. Florida, 1975), with elements of backwards design (Wiggins & McTighe, 1999). The two are very similar, but more faculty are familiar with backwards design. 
...
_ADDIE model of instructional design, mapped onto backwards design workflow._<br>

Next comes the design and development phase. Typically we cycle back and forther between the two many times prior to implementation, so for simplicity I combined them into one step. This better fits the backwards design model as well, where design is part of the cyclic phase.
