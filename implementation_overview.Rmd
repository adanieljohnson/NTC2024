...
Each section below looks at a different logistics issue. The list of questions is not exhaustive, but should be enough to guide you through common pitfalls of using cases. 
...
* Build on the initial information surfaced by the main case activities and questions.
* Push students to find the limits of the conclusions they just reached or make them find other example of principles they have learned.

I also make use of materials I collected while writing the case. As students are discussing a case, I may find that I did not provide enough supporting information. Usually I have some additional resources that I can provide on the spot. 
